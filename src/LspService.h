...
[[nodiscard]] inline constexpr SemanticTokenModifier operator|(
        SemanticTokenModifier a, SemanticTokenModifier b) noexcept {
    return static_cast<SemanticTokenModifier>(
...
struct SemanticTokensResult {
    std::vector<uint32_t> data;  ///< Encoded tokens [deltaLine, deltaStart, length, type, modifiers, ...]
    std::string resultId;
};
...
public:
     ...
     */
    [[nodiscard]] CompletionResult completion(std::string_view uri,
                                               Position position,
     ...
     */
    [[nodiscard]] std::vector<LocationLink> definition(std::string_view uri,
                                                        Position position);
     ...
     */
    [[nodiscard]] std::vector<LocationLink> declaration(std::string_view uri,
                                                         Position position);
     ...
     */
    [[nodiscard]] std::vector<LocationLink> typeDefinition(std::string_view uri,
                                                            Position position);
     ...
     */
    [[nodiscard]] std::vector<Location> references(std::string_view uri,
                                                    Position position,
     ...
     */
    [[nodiscard]] std::optional<WorkspaceEdit> rename(std::string_view uri,
                                                       Position position,
     ...
     */
    [[nodiscard]] std::optional<Range> prepareRename(std::string_view uri,
                                                      Position position);
     ...
     */
    [[nodiscard]] std::vector<CodeAction> codeActions(std::string_view uri,
                                                       Range range,
     ...
     * @return Text edits
     */
    [[nodiscard]] std::vector<TextEdit> rangeFormatting(std::string_view uri,
                                                         Range range,
                                                         const FormattingOptions& options);
 ...
 */
[[nodiscard]] std::string createHoverMarkdown(const semantic::Symbol* symbol,
                                               types::TypeRef type);
