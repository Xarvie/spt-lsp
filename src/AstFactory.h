...
public:
     ...
     */
    template<typename T>
    [[nodiscard]] ArrayView<T> makeArrayView(const std::vector<T>& vec) {
        if (vec.empty()) {
     ...
     */
    template<typename T>
    [[nodiscard]] ArrayView<T> makeArrayView(std::initializer_list<T> list) {
        if (list.size() == 0) {
            return ArrayView<T>{nullptr, 0};
        }
...
public:
    AstFactory() = default;
    explicit AstFactory(size_t arenaBlockSize)
        : arena_(arenaBlockSize) {}
    ...
    [[nodiscard]] ErrorExprNode* makeErrorExpr(SourceRange range, 
    ...
    [[nodiscard]] ErrorStmtNode* makeErrorStmt(SourceRange range,
                                                std::string_view message = "") {
    ...
    [[nodiscard]] ErrorDeclNode* makeErrorDecl(SourceRange range,
                                                std::string_view message = "") {
    ...
    [[nodiscard]] ErrorTypeNode* makeErrorType(SourceRange range,
                                                std::string_view message = "") {
    ...
    [[nodiscard]] StringLiteralNode* makeStringLiteral(SourceRange range,
    ...
    [[nodiscard]] IdentifierNode* makeIdentifier(SourceRange range,
    ...
    [[nodiscard]] QualifiedIdentifierNode* makeQualifiedIdentifier(
            SourceRange range,
     ...
     */
    [[nodiscard]] MemberAccessExprNode* makeMemberAccessExpr(
            SourceRange range,
            Expr* base,
    ...
    [[nodiscard]] IndexExprNode* makeIndexExpr(SourceRange range,
                                                Expr* base,
                                                Expr* index) {
    ...
    [[nodiscard]] ColonLookupExprNode* makeColonLookupExpr(
            SourceRange range,
            Expr* base,
            std::string_view member) {
    ...
    [[nodiscard]] BinaryExprNode* makeBinaryExpr(SourceRange range,
                                                  BinaryOp op,
                                                  Expr* left,
                                                  Expr* right,
                                                  SourceLoc opLoc = {}) {
    ...
    [[nodiscard]] UnaryExprNode* makeUnaryExpr(SourceRange range,
                                                UnaryOp op,
                                                Expr* operand,
                                                bool isPrefix = true) {
    ...
    [[nodiscard]] CallExprNode* makeCallExpr(SourceRange range,
                                              Expr* callee,
    ...
    [[nodiscard]] NewExprNode* makeNewExpr(SourceRange range,
                                            QualifiedIdentifierNode* typeName,
                                            const std::vector<Expr*>& args) {
    ...
    [[nodiscard]] ListExprNode* makeListExpr(SourceRange range,
    ...
    [[nodiscard]] MapEntryNode* makeMapEntry(SourceRange range,
                                              Expr* key,
                                              Expr* value,
    ...
    [[nodiscard]] LambdaExprNode* makeLambdaExpr(
            SourceRange range,
            TypeNode* returnType,
    ...
    [[nodiscard]] AssignStmtNode* makeAssignStmt(SourceRange range,
                                                  Expr* target,
                                                  Expr* value) {
    ...
    [[nodiscard]] MultiAssignStmtNode* makeMultiAssignStmt(
            SourceRange range,
    ...
    [[nodiscard]] UpdateAssignStmtNode* makeUpdateAssignStmt(
            SourceRange range,
            UpdateOp op,
            Expr* target,
            Expr* value) {
    ...
    [[nodiscard]] IfStmtNode* makeIfStmt(
            SourceRange range,
    ...
    [[nodiscard]] WhileStmtNode* makeWhileStmt(SourceRange range,
                                                Expr* condition,
                                                BlockStmtNode* body) {
    ...
    [[nodiscard]] ForStmtNode* makeForStmtCStyle(
            SourceRange range,
            Stmt* init,
            Expr* condition,
    ...
    [[nodiscard]] ForStmtNode* makeForStmtForEach(
            SourceRange range,
    ...
    [[nodiscard]] ImportStmtNode* makeImportStmtNamespace(
            SourceRange range,
    ...
    [[nodiscard]] ImportStmtNode* makeImportStmtNamed(
            SourceRange range,
            std::string_view modulePath,
    ...
    [[nodiscard]] VarDeclNode* makeVarDecl(
            SourceRange range,
            std::string_view name,
            TypeNode* type,
    ...
    [[nodiscard]] MultiVarDeclNode* makeMultiVarDecl(
            SourceRange range,
    ...
    [[nodiscard]] ParameterDeclNode* makeParameterDecl(
            SourceRange range,
            std::string_view name,
            TypeNode* type,
    ...
    [[nodiscard]] FunctionDeclNode* makeFunctionDecl(
            SourceRange range,
            std::string_view name,
            TypeNode* returnType,
            const std::vector<ParameterDeclNode*>& parameters,
            BlockStmtNode* body,
    ...
    [[nodiscard]] FieldDeclNode* makeFieldDecl(
            SourceRange range,
            std::string_view name,
            TypeNode* type,
            Expr* initializer = nullptr,
    ...
    [[nodiscard]] MethodDeclNode* makeMethodDecl(
            SourceRange range,
            std::string_view name,
            TypeNode* returnType,
            const std::vector<ParameterDeclNode*>& parameters,
    ...
    [[nodiscard]] ClassDeclNode* makeClassDecl(
            SourceRange range,
            std::string_view name,
    ...
    [[nodiscard]] CompilationUnitNode* makeCompilationUnit(
            SourceRange range,
    ...
    [[nodiscard]] ListTypeNode* makeListType(SourceRange range,
    ...
    [[nodiscard]] MapTypeNode* makeMapType(SourceRange range,
                                            TypeNode* keyType = nullptr,
    ...
    [[nodiscard]] QualifiedTypeNode* makeQualifiedType(
            SourceRange range,
    ...
    [[nodiscard]] ImportSpecifier makeImportSpecifier(
            std::string_view name,
